...
<head>
    ...
    <meta http-equiv="x-ua-compatible" content="ie=edge">
        ...
        <meta name="title" content="Tata Boga"/>
...
<section class="welcome_about">
    ...
    <div class="row">
            <div class="col-md-7">
                <h2>Program Keahlian: Kuliner </h2>
                <p>Kompetensi keahlian Tata Boga adalah kompetensi keahlian yang
                    menekankan keahlian pada bidang kuliner.
                    Kompetensi keahlian Tata Boga merupakan kompetensi yang paling diminati
                    di SMK ICB Cinta Wisata. Pada program keahlian ini menyiapkan peserta didik
                    untuk bekerja pada bidang pariwisata khususnya kuliner. Adapun paparan teori
                    maupun praktik yang diajarkan mengenai:
                </p>
                <p1>
                1. Pembuatan pastry dan bakery<br>
                2. pengolahan dan penyajian makanan <br>
                3. F & B Service  <br>
                </p1>
                <p1>
                Selain kelas reguler, kompetensi keahlian Tata Boga bekerja sama dan membuka Kelas Industri dengan Hotel InterContinental Bandung.
                </p1>
                </div>
            <div class="col-md-5">
                ...
                <img class="d-block mw-100" src="<?php echo base_url().'theme/images/jasaboga2.jpg'?>" alt="First slide">
                </div>
                <div class="carousel-item">
                <img class="d-block mw-100" src="<?php echo base_url().'theme/images/jasaboga1.jpg'?>" alt="Second slide">
                </div>
                <div class="carousel-item">
                <img class="d-block mw-100" src="<?php echo base_url().'theme/images/jasaboga3.jpg'?>" alt="Second slide">
                </div>
                <div class="carousel-item">
                <img class="d-block w-100" src="<?php echo base_url().'theme/images/jasaboga4.jpg'?>" alt="Third slide">
                </div>
                <div class="carousel-item">
                <img class="d-block mw-100" src="<?php echo base_url().'theme/images/jasaboga5.jpg'?>" alt="Second slide">
                </div>
                </div>
