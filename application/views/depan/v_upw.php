...
<head>
    ...
    <title> Usaha Perjalanan Wisata </title>
    <link rel="shorcut icon" href="<?php echo base_url().'theme/images/icb.png'?>">
    <!-- Bootstrap CSS -->
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-7">
                ...
                <p>Kompetensi keahlian Usaha Perjalanan Wisata (UPW) merupakan kompetensi keahlian yang menekankan keahlian pada bidang pengelolaan perjalanan wisata,pemandu wisata, maupun layanan kehumasan.
                </p>
                <p>Program Kompetensi Keahlian Usaha Perjalanan Wisata (UPW) mempelajariberbagai teori maupun praktik secara langsung mengenai:
                </p>
                <p1> 
                1. Tour Planning<br>
                2. Tourguiding <br>
                3. MICE <br>
                4. Ticketing and Reservation<br>
                </p1>
                </div>
                <div class="col-md-5">
                ...
                <img class="d-block mw-100" src="<?php echo base_url().'theme/images/upw1.jpeg'?>" alt="First slide">
                </div>
                
                <div class="carousel-item">
                <img class="d-block mw-100" src="<?php echo base_url().'theme/images/upw1.jpeg'?>" alt="Second slide">
                </div>
                <div class="carousel-item">
                <img class="d-block mw-100" src="<?php echo base_url().'theme/images/upw2.jpeg'?>" alt="Third slide">
                </div>
                <div class="carousel-item">
                <img class="d-block mw-100" src="<?php echo base_url().'theme/images/upw3.jpeg'?>" alt="Third slide">
                </div>
                <div class="carousel-item">
                <img class="d-block mw-100" src="<?php echo base_url().'theme/images/upw4.jpeg'?>" alt="Third slide">
                </div>
