...
class pendaftaran extends CI_Controller{
	...
	public function excel()
		...
		public function edit_pendaftaran(){
          ...
          $nomer_telepone=strip_tags($this->input->post('xnomer_telepone'));
          $nama_orang_tua=strip_tags($this->input->post('xnama_orang_tua'));
          $telepone_orang_tua=strip_tags($this->input->post('xtelepone_orang_tua'));
          $jurusan_yangdiambil=strip_tags($this->input->post('xjurusan_yangdiambil'));
          $nama_sekolah=strip_tags($this->input->post('xnama_sekolah'));
          $alamat_sekolah=strip_tags($this->input->post('xalamat_sekolah'));
          $rekomendasi=strip_tags($this->input->post('xrekomendasi'));
